...
<body>
<div class="container">
  <div style="width: 100%; height: 453px; left: 0px; top: 0px; position: relative">
    <div style="width: 100%; height: 453px; left: 0px; top: 0px; position: absolute"></div>
    <div class="navbar mt-4" style="z-index: 10; padding-right: 50px">
      <div style="justify-content: flex-start; align-items: center; gap: 50px; display: flex; padding-left: 80px; padding-top: 5px;">
      ...
      <div>
        <button type="button" class="btn custom-button btn-lg" style="padding-left: 32px; padding-right: 32px; margin-right: 30px; border-radius: 8px;font-family: Lexend Deca; font-weight: 600; font-size: 16px;  color: #2562A0; border-color: #2562A0;">Katalog Produk</button>
        <button type="button" class="btn btn-primary btn-lg" style="padding-left: 32px; padding-right: 32px; background: #2562A0; border-radius: 8px;font-family: Lexend Deca; font-weight: 600; font-size: 16px" >Hubungi Kami</button>
      </div>
    </div>
    <div class="text-center mt-5" style="align-items: center; padding-left: 200px; padding-right: 200px">
      <p style="color: black; font-size: 62px; font-family: Lexend Deca; font-weight: 700; word-wrap: break-word">Katalog Produk</p>
      <span style="width: 920px; text-align: center; color: #163B60; font-size: 24px; font-family: DM Sans; font-weight: 400; line-height: 40px; word-wrap: break-word">
      Kami dengan bangga mempersembahkan kepada Anda katalog lengkap produk-produk unggulan dari Sean Solutions. Kami berkomitmen untuk memberikan produk-produk berkualitas tinggi yang dirancang untuk memenuhi berbagai kebutuhan industri.</span>
    </div>
  </div>
    ...
    <table class="table" style="margin-top: 100px;">
      <thead>
        <tr>
          ...
          <th scope="row" style="width: 15%">Brosur</th>
          <th scope="col" style="width: 15%">SDS</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          ...
          <td>
            <button class="btn transparent-btn">
                <img src="{{ asset('image/material-symbols_download.png') }}" alt="Button Image" class="btn-image">
                <span style="color: #136EF0">Unduh Brosur</span>
            </button>
          </td>
          <td>
            <button class="btn transparent-btn">
                <img src="{{ asset('image/material-symbols_download.png') }}" alt="Button Image" class="btn-image">
                <span style="color: #136EF0">Unduh SDS</span>
            </button>
          </td>
        </tr>
        <tr>
  ...
  <div style="width: 100%; height: 319px; left: 0px; margin-top: 140px; position: absolute">
