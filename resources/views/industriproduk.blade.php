...
<head>
  ...
  <link href="{{ asset('css/industriproduk.css?v=').time()}}" type="text/css" rel="stylesheet">
...
<body>
  <div class="container">
    <div style="width: 100%; height: 453px; left: 0px; top: 0px; position: relative">
      ...
      <div style="align-items: center; padding-left: 80px; padding-right: 80px; margin-top: 100px ">
        <p style="color: black; font-size: 50px; font-family: Lexend Deca; font-weight: 700; word-wrap: break-word">{{ $industri->name }}</p>
        <span style="width: 920px; color: #163B60; font-size: 24px; font-family: DM Sans; font-weight: 400; line-height: 40px; word-wrap: break-word;">{{ $industri->detail }}</span>
      </div>
    </div>
    <div class="text-center" style="width: 100%; height: 1811px; left: 0px; top: 844px; position: absolute; background: #163B60; padding: 80px">
      <p style="color: white; font-size: 50px; font-family: Lexend Deca; font-weight: 700; word-wrap: break-word; margin-top: 250px">Temukan Produk Yang Tepat Untuk Permasalahan Industri Anda</p>

      <ul class="row mt-4" style="gap: 35px;">
        @foreach ($family_product as $item)
          <li class="col">
            <button class="list-group-items product-category rounded" data-id1="{{ $item->id }}" data-id2="{{ $industri->id }}" onclick="">{{$item->name}}</button>
          </li>
        @endforeach
      </ul>

      <div id="dataContainer" class="row mt-5" >
        <div class="col list-group-item bg-transparent">
          <img class="img-product" src="{{ asset('image/imgdummyproduct.png') }}" />
          <div class="content-product">
              <div class="mt-3 title-product">MYSTIK GREASE</div>
              <div class="desc-product">MYSTIK GREASE</div>
          </div>
        </div>
        <div class="col list-group-item bg-transparent">
          <img class="img-product" src="{{ asset('image/imgdummyproduct.png') }}" />
    ...
    <div style="height: 100%; margin-top: 80px; position: relative">
      <img class="w-100" style="border-radius: 24px; position: absolute;" src="{{ asset('image/' . $industri->image_detail) }}" />
    </div>
  ...
  <script src="{{ asset('js/button-change-list.js') }}"></script>
