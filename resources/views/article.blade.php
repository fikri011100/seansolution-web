...
<body>
<div class="container" style="position: absolute; background: #FAFAFA">
    <div style="width: 1440px; height: 453px; left: 0px; top: 0px; position: absolute">
        <div style="width: 1440px; height: 453px; left: 0px; top: 0px; position: absolute; background: #163B60"></div>
        <div style="left: 373px; top: 193px; position: absolute; flex-direction: column; justify-content: center; align-items: center; gap: 24px; display: inline-flex">
            <div style="width: 683px; text-align: center; color: white; font-size: 64px; font-family: Plus Jakarta Sans; font-weight: 700; line-height: 64px; word-wrap: break-word">Artikel</div>
            <div style="width: 695px; height: 66px; text-align: center; color: white; font-size: 24px; font-family: DM Sans; font-weight: 400; word-wrap: break-word">Cerita dan informasi terbaru. Baca semua artikel soal Seans Solutions di sini.<br/></div>
        </div>
    ...
    <div style="left: 80px; top: 551px; position: absolute; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 55px; display: inline-flex">
        <div style="height: 466px; justify-content: flex-start; align-items: flex-start; gap: 39px; display: inline-flex">
        ...
        <div style="height: 466px; justify-content: flex-start; align-items: flex-start; gap: 39px; display: inline-flex">
          <a href="{{route('detailartikel')}}">
            <div style="width: 400px; height: 466px; flex-direction: column; justify-content: flex-start; align-items: flex-start; display: inline-flex">
              <img style="width: 400px; height: 260px" src="{{ asset('image/Rectangle 40 (1).png') }}" />
              <div style="width: 400px; height: 207px; background: white; border: 0.50px solid; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 12px; display: flex">
                  <div style="margin-left: 24px; margin-top: 24px; color: #90A2B2; font-size: 14px; font-family: Plus Jakarta Sans; font-weight: 400; line-height: 20px; word-wrap: break-word">1 Juli 2023</div>
                  <div style="margin-left: 24px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 16px; display: flex">
                      <div style="width: 347px; color: #1D242A; font-size: 20px; font-family: Lexend Deca; font-weight: 500; word-wrap: break-word">Mengenal Degreaser : Pengertian, Based dan Fungsi Degreaser</div>
                      <div style="width: 347px; color: #5C7184; font-size: 14px; font-family: DM Sans; font-weight: 400; word-wrap: break-word">Engine overhaul merupakan suatu kegiatan pembongkaran mesin atau yang lebih dikenal dengan istilah turun mesin pada kendaraan.</div>
                  </div>
              </div>
          ...
          <a href="{{route('detailartikel')}}">
            <div style="width: 400px; height: 466px; flex-direction: column; justify-content: flex-start; align-items: flex-start; display: inline-flex">
                <img style="width: 400px; height: 260px" src="{{ asset('image/Rectangle 40 (2).png') }}" />
                <div style="width: 400px; height: 207px; background: white; border: 0.50px solid; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 12px; display: flex">
                    <div style="margin-left: 24px; margin-top: 24px; color: #90A2B2; font-size: 14px; font-family: Plus Jakarta Sans; font-weight: 400; line-height: 20px; word-wrap: break-word">1 Juli 2023</div>
                    <div style="margin-left: 24px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 16px; display: flex">
                        <div style="width: 367px; color: #1D242A; font-size: 20px; font-family: Lexend Deca; font-weight: 500; word-wrap: break-word">Yuk, Beralih Menggunakan Chemicals Ramah Lingkungan!</div>
          ...
          <a href="{{route('detailartikel')}}">
            <div style="width: 400px; height: 466px; flex-direction: column; justify-content: flex-start; align-items: flex-start; display: inline-flex">
                <img style="width: 400px; height: 260px" src="{{ asset('image/Rectangle 40.png') }}" />
                <div style="width: 400px; height: 207px; background: white; border: 0.50px solid; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 12px; display: flex">
                    <div style="margin-left: 24px; margin-top: 24px; color: #90A2B2; font-size: 14px; font-family: Plus Jakarta Sans; font-weight: 400; line-height: 20px; word-wrap: break-word">1 Juli 2023</div>
                    <div style="margin-left: 24px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 16px; display: flex">
    ...
    <div style="width: 1440px; height: 319px; left: 0px; top: 1961px; position: absolute">
