...
<head>
  ...
  <link href="{{ asset('css/article.css?v=').time()}}" type="text/css" rel="stylesheet">
  <!-- Styles -->
  <style>
...
<div class="container" style="position: absolute; background: #FAFAFA">
    <div id="navbar-web" style="width:100%; height: 453px; left: 0px; top: 0px; position: absolute">
        ...
        <div class="d-flex flex-column w-100 text-center" style="top: 180px; position: absolute;">
            <div style="color: white; font-size: 48px; font-family: Lexend Deca; font-weight: 700; word-wrap: break-word">Artikel</div>
            <div style="margin-top: 20px; color: white; font-size: 24px; font-family: Lexend Deca; font-weight: 400; word-wrap: break-word">Cerita dan informasi terbaru. Baca semua artikel soal Seans Solutions di sini.</div>
        </div>
    ...
    <div class="" style="width: 100%; left: 0; top: 551px; position: absolute;">
        <div id="articleList">
            <a href="{{route('detailartikel')}}" class="card border-secondary " id="articleCard">
