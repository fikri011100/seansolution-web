...
<body>
<div class="container">
  <div style="width:100%; height: 319px; left: 0px; top: 2655px; position: absolute">
      ...
      <div style="left: 80px; top: 63px; position: absolute; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 42px; display: inline-flex">
          <img style="width: 232px; height: 82px" src="{{ asset('image/logo.png') }}" />
      </div>
  ...
  <div style="width:100%; left: 0px; top: 1018px; position: absolute; justify-content: flex-start; align-items: flex-start; gap: 16px; display: inline-flex">
      <img style="width: 480px; height: 296px; background: linear-gradient(0deg, #D9D9D9 0%, #D9D9D9 100%)" src="{{ asset('image/Rectangle 4539.png') }}" />
      <img style="width: 480px; height: 296px; background: linear-gradient(0deg, #D9D9D9 0%, #D9D9D9 100%)" src="{{ asset('image/Rectangle 4540.png') }}" />
      <img style="width: 480px; height: 296px; background: linear-gradient(0deg, #D9D9D9 0%, #D9D9D9 100%)" src="{{ asset('image/Rectangle 4541.png') }}" />
  </div>
  ...
  <div style="width:100%; padding-left: 80px; padding-right: 80px; padding-top: 108px; padding-bottom: 108px; left: 0px; top: 2093px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
      <div style="flex: 1 1 0; align-self: stretch; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 32px; display: inline-flex">
          <div style="width: 1280px; color: #0D2238; font-size: 40px; font-family: Lexend Deca; font-weight: 500; line-height: 64px; word-wrap: break-word">Layanan Kami</div>
          <div style="justify-content: flex-start; align-items: flex-start; gap: 41px; display: inline-flex">
              <div style="width: 324px; height: 250px; padding-left: 24px; padding-right: 24px; padding-top: 30px; border-radius: 8px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: inline-flex">
                  ...
                  <div style="flex-direction: column; justify-content: center; align-items: flex-start; gap: 16px; display: flex">
                      ...
                      <div style="width: 304px; color: #0D2238; font-size: 16px; font-family: DM Sans; font-weight: 400; word-wrap: break-word">Specialty Grease, Hydraulic Oil, Turbine Oil, Compressor Oil, Graphite Powder, Engine Oil, Heat Transfer Fluid, White Oil, Wire Pulling Lubricant, ETC</div>
                  </div>
              </div>
              <div style="width: 289px; height: 250px; padding-left: 24px; padding-right: 24px; padding-top: 30px; border-radius: 8px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: inline-flex">
                  ...
                  <div style="flex-direction: column; justify-content: center; align-items: flex-start; gap: 16px; display: flex">
                      ...
                      <div style="width: 249px; color: #0D2238; font-size: 16px; font-family: DM Sans; font-weight: 400; word-wrap: break-word">Automation Lubricants untuk berbagai aplikasi yang dapat meningkatkan efisiensi re-grasing pada asset-aset bergerak anda.</div>
                  </div>
              </div>
              <div style="width: 289px; height: 250px; padding-left: 24px; padding-right: 24px; padding-top: 30px; border-radius: 8px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: inline-flex">
                  <div style="width: 40px; height: 40px; position: relative">
                  ...
                  <div style="flex-direction: column; justify-content: center; align-items: flex-start; gap: 16px; display: flex">
                      ...
                      <div style="width: 249px; color: #0D2238; font-size: 16px; font-family: DM Sans; font-weight: 400; word-wrap: break-word">Berbagai jenis solution coating yang dapat melindungi segala bentuk asset anda agar lebih terproteksi dan menarik secara estetika</div>
                  </div>
              </div>
              <div style="width: 289px; height: 250px; padding-left: 24px; padding-right: 24px; padding-top: 30px; border-radius: 8px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: inline-flex">
                  <div style="width: 40px; height: 40px; position: relative">
                  ...
                  <div style="flex-direction: column; justify-content: center; align-items: flex-start; gap: 16px; display: flex">
                      ...
                      <div style="width: 249px; color: #0D2238; font-size: 16px; font-family: DM Sans; font-weight: 400; word-wrap: break-word">Memberikan chemical solution untuk mempermudah pekerjaan maintenance</div>
                  </div>
              </div>
          </div>
      </div>
  </div>
  <div style="width:100%; height: 453px; left: 0px; top: 0px; position: absolute">
  ...
  <div style="padding-left: 80px; padding-right: 80px; padding-top: 68px; padding-bottom: 68px; left: 0px; top: 453px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
      <div style="align-self: stretch; justify-content: flex-start; align-items: center; gap: 110px; display: inline-flex">
          <div style="flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: inline-flex">
          ...
          <div style="flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 43px; display: inline-flex">
